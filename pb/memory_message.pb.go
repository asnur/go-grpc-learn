...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=grpc.learn.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x72, 0x6e, 0x22, 0xab, 0x01, 0x0a, 0x06, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x12, 0x14, 0x0a,
	...
	0x0e, 0x32, 0x17, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x6c, 0x65, 0x61, 0x72, 0x6e, 0x2e, 0x4d,
	...
	0x42, 0x0f, 0x5a, 0x0d, 0x67, 0x72, 0x70, 0x63, 0x5f, 0x6c, 0x65, 0x61, 0x72, 0x6e, 0x2f, 0x70,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: grpc.learn.Memory.Unit
	(*Memory)(nil),   // 1: grpc.learn.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: grpc.learn.Memory.unit:type_name -> grpc.learn.Memory.Unit
