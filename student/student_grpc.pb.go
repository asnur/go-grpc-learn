...
type DataStudentClient interface {
	...
	FindAllStudent(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*StudentList, error)
}
...
func (c *dataStudentClient) FindAllStudent(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*StudentList, error) {
	out := new(StudentList)
	err := c.cc.Invoke(ctx, "/student.DataStudent/FindAllStudent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DataStudentServer interface {
	...
	FindAllStudent(context.Context, *emptypb.Empty) (*StudentList, error)
...
func (UnimplementedDataStudentServer) FindAllStudent(context.Context, *emptypb.Empty) (*StudentList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindAllStudent not implemented")
}
...
func _DataStudent_FindAllStudent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DataStudentServer).FindAllStudent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/student.DataStudent/FindAllStudent",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DataStudentServer).FindAllStudent(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DataStudent_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FindAllStudent",
			Handler:    _DataStudent_FindAllStudent_Handler,
		},
	},
